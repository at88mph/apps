...
public class ScriptGenerator {
    ...
    void generate(final Writer writer) throws IOException {
        ...
        final String curlCommandPrefix = StringUtil.hasLength(this.authToken)
                                         ? String.format(ScriptGenerator.AUTH_CURL_COMMAND_PREFIX, this.authToken)
                                         : ScriptGenerator.ANON_CURL_COMMAND_PREFIX;
